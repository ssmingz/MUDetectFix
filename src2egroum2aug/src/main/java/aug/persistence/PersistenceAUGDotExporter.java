...
public class PersistenceAUGDotExporter extends AUGDotExporter {
    ...
    static {
        ...
        AUG_ELEMENT_TYPE_TO_LABEL.put(RepetitionTrueEdge.class, "Re_T"); // added by jaz
        AUG_ELEMENT_TYPE_TO_LABEL.put(SelectionTrueEdge.class, "S_T"); // added by jaz
        AUG_ELEMENT_TYPE_TO_LABEL.put(RepetitionFalseEdge.class, "Re_F"); // added by jaz
        AUG_ELEMENT_TYPE_TO_LABEL.put(SelectionFalseEdge.class, "S_F"); // added by jaz
