...
//								new EGroumDataEdge(e1.source, this, de.type, de.label + "_" + e.getLabel());
							if(de.label != null && (de.label.equals("sel") || de.label.equals("rep"))) {
								if(e.getLabel().isEmpty()) {
									for(EGroumEdge e2 : e.source.getInEdges()) {
										if(e2.source == e.source.control) {
											new EGroumDataEdge(e1.source, this, de.type, de.label + "_" + e2.getLabel());
											return ;
										}
									}
								}
